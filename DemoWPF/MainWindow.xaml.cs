...
namespace unvell.ReoGrid.WPFDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            grid.SettingsChanged += (s, e) => this.UpdateMenuChecks();
            grid.CurrentWorksheetChanged += (s, e) => this.UpdateMenuChecks();
            ...
            this._taskExamples.ForEach(t => t.Apply(grid));
        }
            ...
            if (dlg.ShowDialog() == true)
            {
                ...
                try
                {
                    ...
                    var startInfo = new System.Diagnostics.ProcessStartInfo
                    {
                        ...
                        UseShellExecute = true // Ensure the file opens with its associated program
                    };
